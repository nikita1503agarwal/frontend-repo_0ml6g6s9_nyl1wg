...
const brand = {
  name: 'AB FINANZEN',
  colors: {
    bg: '#0b0b0d', // deep graphite black
    surface: '#0f1013',
    soft: '#1a1b1f',
    text: '#e6e7eb',
    sub: '#a8acb3', // platinum grey
        ...
        <div className="relative z-10">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: 'easeOut' }} className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs tracking-widest text-white/70">
              MUNICH • FINANCE
              <span className="ml-2 inline-block h-1.5 w-1.5 rounded-full" style={{ backgroundColor: brand.colors.gold }} />
            </div>
            <h1 className="text-balance text-4xl font-extrabold leading-[1.05] text-white sm:text-5xl md:text-6xl">
              Precision financing for complex decisions.
            </h1>
            <p className="max-w-xl text-base leading-relaxed text-white/70 sm:text-lg">
              {brand.name} delivers reliable, individualized strategies with absolute clarity, transparency, and long‑term alignment.
            </p>
            <div className="flex items-center gap-4 pt-2">
              <a href="#consult" className="group relative inline-flex items-center justify-center rounded-md px-5 py-3 text-sm font-semibold text-black focus:outline-none" style={{ backgroundColor: brand.colors.gold }}>
